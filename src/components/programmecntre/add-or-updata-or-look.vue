...
export default {
  ...
  data () {
    ...
    return {
      ...
      demandList: [
        ...
        { name: '归属机构', code: 'organizeId', span: 12, type: 'open', rule: [{ required: true, message: '请选择', trigger: 'change' }], edit: true },
        { name: '是否省公司需求', code: 'provinceDemand', span: 12, type: 'select', dictType: 'yesOrNo', rule: [{ required: true, message: '请选择', trigger: 'change' }], edit: true },
        { name: '是否生产验证', code: 'produceCheck', span: 12, type: 'select', dictType: 'yesOrNo', rule: [{ required: true, message: '请选择', trigger: 'change' }], edit: true },
        { name: '责任人', code: 'personLiable', span: 12, type: 'open', rule: [{ required: true, message: '请选择', trigger: 'change' }], edit: true },
        { name: '联系电话', code: 'contactPhone', span: 12, type: 'input', rule: [{ required: true, validator: phone, trigger: 'blur' }], edit: true },
        { name: '需求方', code: 'demandSide', span: 12, type: 'input', rule: [{ required: true, message: '请输入', trigger: 'blur' }], edit: true },
        { name: '需求业务类型', code: 'demandBusinessType', span: 12, type: 'select', dictType: 'permissionLevel', rule: [{ required: true, message: '请选择', trigger: 'change' }], edit: true },
        { name: '需求客户类型', code: 'demandCustomerType', span: 12, type: 'select', dictType: 'permissionLevel', rule: [{ required: true, message: '请选择', trigger: 'change' }], edit: true },
        { name: '需求使用范围', code: 'demandUseScope', span: 12, type: 'select', dictType: 'scopeOfRequirements', rule: [{ required: true, message: '请选择', trigger: 'change' }], edit: true },
        { name: '需求说明', code: 'description', span: 24, type: 'textarea', rule: [{ required: true, message: '请输入需求名称', trigger: 'change' }], edit: true },
  ...
  methods: {
    ...
    submit1 () {
      ...
      this.$http.post('/ctc/plan/demand', params).then(({ data: res }) => {
