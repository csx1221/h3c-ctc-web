            ...
            <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="180px">
                                ...
                                <el-card shadow="never" class="aui-card--fill">
                                    <el-row style="margin-bottom:20px;margin-top:10px;">
                                        <el-col :span="6" class="split-line" style="text-align:left;">
                                            4A主账号列表
                                            <el-badge v-if="echoData.mainList" :value="echoData.mainList.length" size="mini" class="item"></el-badge>
                                        </el-col>
                                    </el-row>
                                    <el-table max-height="450" stripe :data="echoData.mainList" border style="width: 100%;">
                                    ...
                                    <el-row style="margin-bottom:20px;margin-top:10px;">
                                        <el-col :span="6" class="split-line" style="text-align:left;">
                                            4A从账号列表
                                            <el-badge v-if="echoData.subList" :value="echoData.subList.length" size="mini" class="item"></el-badge>
                                        </el-col>
                                    </el-row>
                                    <el-table max-height="450" stripe :data="echoData.subList" border style="width: 100%;">
                                        <!--                    <el-table-column :selectable="selectable" type="selection" width="45"></el-table-column>-->
                                        <el-table-column type="index" width="60" label="序号" align="center"></el-table-column>
                                        <template v-for="(item, index) in accountTitleDataListSub">
                                            <el-table-column :key="index" :label="item.name" align="center" show-overflow-tooltip>
                                                <template slot-scope="scope">
                                                    <span v-html="getTableColumnData(scope.row,item)"></span>
                                                </template>
                        ...
                        <el-row class="project-mgr-page account-4a">
                            <el-col :span="24">
                                <el-card shadow="never" class="aui-card--fill">
                                    ...
                                    <el-table max-height="450px" stripe :data="echoData.mangerUpdateList" border style="width: 100%;">
                                        <!--                    <el-table-column :selectable="selectable" type="selection" width="45"></el-table-column>-->
                                        <el-table-column type="index" width="60" label="序号" align="center"></el-table-column>
                                        <template v-for="(item, index) in managerDataList">
                                            <el-table-column :key="index" :label="item.name" align="center" show-overflow-tooltip>
                                                <template slot-scope="scope">
                                                    <span v-html="getTableColumnData(scope.row,item)"></span>
                                                </template>
                ...
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="注销原因：" prop="reason">
                        <ctc-select v-model="echoData.reason" dict-type="cancelCause" placeholder="请选择" disabled></ctc-select>
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item prop="cancelContent" label="注销说明：">
                        <el-input v-model="echoData.cancelContent" placeholder="请输入" :rows="5" type="textarea" disabled></el-input>
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
