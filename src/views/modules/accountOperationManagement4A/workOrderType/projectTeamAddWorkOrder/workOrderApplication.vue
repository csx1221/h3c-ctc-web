                            ...
                            <el-col :span="24">
                                <el-card shadow="never" class="aui-card--fill">
                                    ...
                                    <el-form :model="dataForm.accountList" :rules="dataRules" ref="dataForm_child" label-width="120px">
                                        ...
                                        <template v-if="dataForm.accountList.type==='0'">
                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                <el-form-item label="部门名称：" prop="parentName">
                                                    <el-input v-model="dataForm.accountList.parentName" placeholder="请输入" clearable></el-input>
                                                </el-form-item>
                                            </el-col>
                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                <el-form-item label="部门描述：" prop="parentDesc">
                                                    <el-input v-model="dataForm.accountList.parentDesc" placeholder="请输入" :rows="5" type="textarea" clearable></el-input>
                                                </el-form-item>
                                            </el-col>
                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                <el-form-item label="项目组名称：" prop="orgName">
                                                    <el-input v-model="dataForm.accountList.orgName" placeholder="请输入" clearable></el-input>
                                                </el-form-item>
                                            </el-col>
                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                <el-form-item label="项目组描述：" prop="orgDesc">
                                                    <el-input v-model="dataForm.accountList.orgDesc" placeholder="请输入" :rows="5" type="textarea" clearable></el-input>
                                                </el-form-item>
                                            </el-col>
                                        </template>
                                        <template v-if="dataForm.accountList.type==='2'">
                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                <el-form-item label="部门名称：" prop="parentId">
                                                    <ctc-project-team v-model="dataForm.accountList.parentId" :props="{lv:'1'}" backName :organName.sync="dataForm.accountList.parentName"></ctc-project-team>
                                                </el-form-item>
                                            </el-col>
                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                <el-form-item label="项目组名称：" prop="orgName">
                                        ...
                                        <template v-if="dataForm.accountList.type==='1'">
                                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                                <el-form-item label="部门名称：" prop="parentName">
                                                    <el-input v-model="dataForm.accountList.parentName" placeholder="请输入" clearable></el-input>
                                                </el-form-item>
...
export default {
  ...
  watch: {
    // 申请类型
    'dataForm.accountList.type' (newVal, oldVal) {
      console.log(newVal)
      if (this.isEdit) {
        this.dataForm.accountList.orgName = ''
        this.dataForm.accountList.orgDesc = ''
        this.dataForm.accountList.parentName = ''
        this.dataForm.accountList.parentId = ''
        this.dataForm.accountList.parentDesc = ''

        this.$refs['dataForm_child'].clearValidate(['orgName'])
        this.$refs['dataForm_child'].clearValidate(['parentName'])
        this.$refs['dataForm_child'].clearValidate(['parentId'])
      }
    }
  },
  data () {
  ...
  methods: {
    ...
    submitData (val) {
      ...
      let toCreate = JSON.parse(JSON.stringify(thisvm.dataForm.accountList))
      toCreate.parentId = Array.isArray(this.dataForm.accountList.parentId) ? this.dataForm.accountList.parentId[this.dataForm.accountList.parentId.length - 1] : toCreate.parentId
      if (this.$route.params.type === '1') {
        url = '/account4a/apply/orgainze/create'
        params = { ...data, toCreate: toCreate }
      } else if (this.$route.params.type === '2') {
        url = '/account4a/apply/orgainze/edit'
        params = { ...data, toCreate: toCreate, recordId: thisvm.$route.params.recordId }
      }
    ...
    getEchoData (id) {
      ...
      thisvm.$http.get('/account4a/apply/orgainze/info', { 'params': params }).then(({ data: res }) => {
        thisvm.$ctcLoading.close()
        if (res.code !== 0) {
        ...
        if (res.data) {
          ...
          this.dataForm.accountList = data.toCreateOrganizeForm
          this.dataForm.accountList.type = this.dataForm.accountList.type + ''
          // thisvm.isEdit = true
          setTimeout(() => {
            thisvm.isEdit = true
          }, 1000)
