                                ...
                                <el-card shadow="never" class="aui-card--fill">
                                    <el-row style="margin-bottom:20px;margin-top:10px;">
                                        <el-col :span="6" class="split-line" style="text-align:left;">
                                            集测从账号列表
                                            <el-badge v-if="echoData.ctcAccountList" :value="echoData.ctcAccountList.length" size="mini" class="item"></el-badge>
                                        </el-col>
                                    </el-row>
                                    <el-table max-height="450" stripe :data="echoData.ctcAccountList" border style="width: 100%;">
...
export default {
  ...
  methods: {
    getEchoData (id) {
      ...
      thisvm.$http.get('/account4a/ctc/cancel/account/info', { 'params': params }).then(({ data: res }) => {
