<template>
  <el-dialog :visible.sync="visible" title="子项目详情" width="88%" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-table max-height="500" :header-cell-style="getRowClass" v-loading="dataListLoading" :data="dataList" @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column width="160" prop="projectName" label="子项目名称" header-align="center" align="center" show-overflow-tooltip></el-table-column>
