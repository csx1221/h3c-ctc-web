    ...
    <split-bar>
      ...
      <el-container slot='split_right'>
        <div style="margin-left: 10px;-webkit-box-flex: 1;box-sizing: border-box;flex: 1 1 auto;overflow: auto;">
          <construct-list-page :projectData="projectData" @watchChildTree="triggerParentPage"></construct-list-page>
        </div>
      </el-container>
    </split-bar>
  </el-container>
...
<script>
import ConstructListPage from './construct-list-page'
export default {
  name: 'ConstructPage',
  components: { ConstructListPage },
  data () {
    return {
      nameFromProjectCase: '',
      projectData: {
  ...
  methods: {
    ...
    handleNodeClick (data) {
      ...
      if (nodeType === 1) {
        ...
        projectData.projectName = data.nodeName
