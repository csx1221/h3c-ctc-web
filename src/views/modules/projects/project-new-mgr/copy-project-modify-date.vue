<template>
  <el-dialog title="复制项目-重设周期" :visible.sync="innerVisible" :close-on-click-modal="false" width="30%" class="case-review">
    <el-row>
      <el-col :span="24">
    ...
    handleConfirm () {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          this.$emit('watchChildMethod', { 'type': 'copyProjectModifyDate', 'data': params })
