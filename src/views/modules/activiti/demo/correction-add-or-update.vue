<template>
  <el-dialog :visible.sync="visible" :title="!dataForm.id ? $t('add') : $t('update')" :close-on-click-modal="false" :close-on-press-escape="false">
    ...
    <template slot="footer">
      ...
      <!--  流程启动组件  -->
      <ctc-process-start v-if="processVisible" updateInstanceIdUrl="/activiti/demo/correction/updateInstanceId" saveFormUrl="/activiti/demo/correction" dataFormName="dataForm" ref="ctcProcessStart" ></ctc-process-start>
    </template>
  </el-dialog>
</template>
  ...
  methods: {
    init () {
      ...
      this.$nextTick(() => {
        ...
        this.$refs.ctcProcessStart.rootObj = this
        // 配置回调函数
        this.$refs.ctcProcessStart.callbacks = {
        ...
        // 配置流程定义KEY
        this.$refs.ctcProcessStart.dataForm.processDefinitionKey = 'correctionprocess'
      })
    },
    // 获取信息
    getInfo () {
