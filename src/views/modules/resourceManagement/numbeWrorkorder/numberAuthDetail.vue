    ...
    <el-row>
      ...
      >
        ...
        <div class="from">
          ...
          <el-table  v-loading="dataListLoading"  :data="dataForm.cardnumberList"  border  style="width: 100%">
            ...
            <!-- <el-table-column  prop="operator"  label="运行商"  header-align="center"  align="center"  show-overflow-tooltip></el-table-column> -->
            <el-table-column  prop="applicationName"  label="所属平台"  header-align="center"  align="center"  show-overflow-tooltip>
            </el-table-column>
            <el-table-column  prop="brandDefine"  label="品牌"  header-align="center"  align="center"  show-overflow-tooltip>
               <template slot-scope="scope">
