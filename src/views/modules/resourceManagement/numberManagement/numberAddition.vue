...
export default {
  ...
  methods: {
    ...
    submitData () {
      ...
      console.log(params)
      thisvm.$http[this.dataForm.cardNumberId ? 'put' : 'post'](this.dataForm.cardNumberId ? '/ctc/resource/cardnumber/update' : '/ctc/resource/cardnumber/save', params).then(({ data: res }) => {
