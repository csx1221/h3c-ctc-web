      ...
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        <el-row>
          <el-col :span="24" style="text-align:right;">
            <el-form-item>
              <el-button v-if="$hasPermission('sys:menu:save')" type="primary" size="small" @click="addOrUpdateHandle()">{{ $t('add') }}</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <el-table stripe highlight-current-row v-loading="dataListLoading" :data="dataList" row-key="id" border style="width: 100%;">
        ...
        <el-table-column prop="url" :label="$t('menu.url')" header-align="left" align="left" width="350" :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="permissions" :label="$t('menu.permissions')" header-align="left" align="left" width="200" :show-overflow-tooltip="true"></el-table-column>
