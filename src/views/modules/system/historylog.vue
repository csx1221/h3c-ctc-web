  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-sys__log-operation">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        <el-form-item>
          <el-input v-model="dataForm.moduleName" :placeholder="$t('logOperation.module')" clearable></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @sort-change="dataListSortChangeHandle" style="width: 100%;">
        <el-table-column prop="userName" :label="$t('logOperation.creatorName')" header-align="center" align="center"></el-table-column>
        <el-table-column prop="operation" :label="$t('logOperation.operation')" header-align="center" align="center"></el-table-column>
        <el-table-column prop="moduleName" :label="$t('logOperation.module')" header-align="center" align="center"></el-table-column>
        <el-table-column prop="requestUrl" :label="$t('logOperation.requestUri')" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column prop="operationIp" :label="$t('logOperation.ip')" header-align="center" align="center"></el-table-column>
        ...
        <el-table-column prop="createDt" :label="$t('logOperation.createDate')" sortable="custom" header-align="center" align="center" width="180"></el-table-column>
      </el-table>
      <el-pagination
        :current-page="page"
  ...
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: '/ctc/subadmin/log/page',
        getDataListIsPage: true,
        exportURL: '/ctc/subadmin/log'
      },
      dataForm: {
        moduleName: '',
        status: ''
