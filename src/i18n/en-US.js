...
t.addDevelopment = 'Create development requirements'
t.updateDevelopment = 'Modify development requirements'
t.seeDevelopment = 'Requirements development details'
t.review = 'Requirements development review'
t.assessment = 'Demand development assessment'
t.workload = 'Requirement development workload assessment'
t.receive = 'Requirements development and reception'
t.development = 'Demand development'
t.tracking = 'Process tracking'
t.add = 'Add'
t.delete = 'Delete'
...
t.login.demo = 'Demo'
t.login.copyright = 'CTC'

t.home = {}
t.home.desc = {}
t.home.desc.title = 'Project introduction'
t.home.desc.list = [
  'CTC is a micro service platform based on Spring cloud, providing enterprises with one-stop micro service solutions',
  'Based on the latest development of Spring Cloud Alibaba 2.1, Nacos, Spring Cloud Gateway, Spring Boot 2.1, Mybatis, Element 2.0+'
]
