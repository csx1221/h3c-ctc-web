...
t.deleted = '已删除'
t.undelete = '未删除'
t.addDevelopment = '创建开发需求'
t.updateDevelopment = '修改开发需求'
t.seeDevelopment = '需求开发详情'
t.review = '需求开发评审'
t.assessment = '需求开发评估'
t.workload = '需求开发工作量评估'
t.receive = '需求开发接收'
t.development = '需求开发'
t.tracking = '流程跟踪'
t.add = '新增'
...
t.home.desc.list = [
  '集中测试平台，是基于Spring Cloud打造的微服务平台，为企业提供一站式测试解决方案',
...
t.logOperation.creatorName = '用户账号'
...
t.dome.pop = '项目经理'
t.dome.time = '计划周期'
t.dome.institutions = '归属机构'
t.dome.date = '创建时间'
t.dome.num = '序号'
// 项目任务管理
t.project = {}
t.project.list = '项目列表'
t.project.subList = '子项目列表'
t.project.name = '项目名称'
t.project.notStartTask = '未开始任务'
t.project.processingTask = '处理中任务'
t.project.finishedTask = '已完成任务'
t.project.status = '状态'
t.project.category = '项目类别'
t.project.level = '项目级别'
t.project.range = '项目范围'
t.project.projectManager = '项目经理'
t.project.testObject = '参测对象'
t.project.planningCycle = '计划周期'
t.project.affiliate = '归属机构'
t.project.createDate = '创建时间'
t.project.details = '项目明细'
t.project.taskDetails = '任务明细'
t.project.structure = '项目结构'
t.project.notStart = '未开始'
t.project.normalTest = '正常在测'
t.project.delayTest = '延期在测'
t.project.normalComplete = '正常完成'
t.project.delayComplete = '延期完成'

t.stage = {}
t.stage.list = '阶段列表'
t.stage.name = '阶段名称'
t.stage.basicStage = '基础阶段'
t.stage.start = '开始日期'
t.stage.end = '结束日期'
t.stage.sequential = '时序'
t.stage.status = '状态'
...
t.task.contact = '联系方式'
t.task.member = '成员'
t.task.testType = '测试类型'
t.task.onLineTest = '是否上线前测试'
t.task.yes = '是'
t.task.no = '否'
t.task.configureInfo = '任务配置信息'
t.task.handle = '操作'
t.task.setMember = '设置成员'
t.task.startUp = '启动'
t.task.taskDesign = '任务配置'
t.task.useCaseDesign = '用例设计任务配置'
t.task.useCaseDesignCause = '用例设计的起因'
t.task.useCaseDesignType = '用例类型'
